...
namespace PhoneShopASPnet.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(PhoneShopASPnetContext context)
        {
            _context = context;
        }
        ...
        {
            var _user = _context.Users.Where(m => m.UserEmail == _userFromPage.UserEmail && m.PassWord == _userFromPage.PassWord).FirstOrDefault();
            if (_user == null)
            {
